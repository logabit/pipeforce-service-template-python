...
language. It contains:
    ...
    - A ready-to-use distributed tracing setup so incoming and outgouing HTTP requests and messages can be traced and monitored.
    - A ready-to-use REST endpoint using FAST API
